...
`rospack find pr2_calibration_propagation`/scripts/propagate_config_ref_positions.py $original_system $final_system $urdf_in $urdf_out > /tmp/pr2_calibration/urdf_writer_debug.log
